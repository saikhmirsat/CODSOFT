...
const JobApplicationStatusSchema = mongoose.Schema({
    user: String,
    status: Boolean,
    jobData: Object
}, {
...
const JobApplicationStatusModel = mongoose.model('jobstatus', JobApplicationStatusSchema)
...
//     "educations": [{ "colledgeName": "Masai", "course": "Webdevelopement" }, { "colledgeName": "Utkal University", "course": "Graduation" }],
